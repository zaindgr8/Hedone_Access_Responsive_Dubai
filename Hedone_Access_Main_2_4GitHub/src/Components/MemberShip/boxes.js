...
function Boxes({ title, description, image, bullets }) {
  ...
  return (
    <div
      className={`w-full col-span-1 border border-gray-300 shadow-lg flex flex-col text-center rounded-lg transition-transform duration-300 ${
    ...
    >
      <div className="relative group">
        ...
        />
        <div className="p-4 absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-black bg-opacity-60 rounded-t-lg">
      ...
      <div className="p-4">
        ...
        <Button1 title="Book Now" onClick={handleClick} />
      </div>
    </div>
  );
}
